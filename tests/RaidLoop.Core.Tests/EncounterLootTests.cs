...
public class EncounterLootTests
{
    ...
    public void StartLootEncounter_WithLootTable_ClearsAndAddsDrawnItems()
    {
        ...
        [
            (new Item("New Loot", ItemType.Material, Weight: 1, Slots: 1, Rarity: Rarity.Rare), 10),
            (new Item("Ammo Box", ItemType.Sellable, Weight: 1, Slots: 1, Rarity: Rarity.Common), 10)
        ]);
