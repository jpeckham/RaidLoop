...
values
    ...
    ('raid_neutral_extract_route_clear', 'extract_approach', 'Neutral', 'MutualContact', 200, 40, null, null, null, null, null, 'Area Clear', 'The final stretch to extract is quiet.', true),
    ('raid_loot_extract_abandoned_cache', 'extract_approach', 'Loot', 'MutualContact', 100, 50, null, null, null, 'medical_container', null, 'Loot Encounter', 'You spot an abandoned cache near the extraction route.', true)
